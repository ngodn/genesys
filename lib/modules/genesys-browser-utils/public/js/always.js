genex.define('genesys-browser-utils', {
  construct: function(self, options) {
    ...
    // for `genesys-assets` and the user is not logged in.
    ...
    // Examples:
    //
    // genex.eventName('aposChange', 'blog') ---> aposChangeBlog
    // genex.eventName('aposChangeEvents') ---> aposChangeEvents
    // genex.eventName('genex-jump-gleefully') ---> aposJumpGleefully
    //
    ...
    self.eventName = function() {
      ...
      return genex.camelName(args.join('-'));
    };
    ...
    // an alias for `genex.utils.log`. Note that
    ...
    self.info = function(msg) {
      ...
      genex.utils.log.apply(genex, arguments);
    };
    ...
    self.warn = function(msg) {
      ...
      genex.utils.error.apply(genex, arguments);
    };
