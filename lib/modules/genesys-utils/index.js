...
// ### `logger`
//
// A function which accepts `genex` and returns an object with
...
// is called in its place. Calls to `genex.utils.log`,
// `genex.utils.error`, etc. are routed through this object
...
module.exports = {
  ...
  singletonWarningIfNot: 'genesys-utils',
