...
module.exports = function(self, options) {
  return {
    ...
    // Outputs nothing to the template. Invokes genex.utils.log,
    // which by default invokes console.log.
    log: function(msg) {
      self.log.apply(self.genex, arguments);
      return '';
    },
    ...
    // an array property of the first object, genex.utils.groupByArray is called.
    //
    // Usage: {{ genex.utils.groupBy(people, 'age') }} or {{ genex.utils.groupBy(items, 'tags') }}
    ...
    // those keys. For instance, genex.utils.object('name', 'bob')
