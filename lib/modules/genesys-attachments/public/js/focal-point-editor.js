genex.define('apostrophe-attachments-focal-point-editor', {
  ...
  construct: function(self, options) {
    ...
    self.afterShow = function() {
      ...
      self.$focalPointImage.attr('src', genex.attachments.url(self.attachment, { size: 'original', crop: options.crop }));
