...
module.exports = {
  ...
  afterConstruct: function(self, callback) {
    return async.series({
      ...
      self.addPermissions();
      self.genex.tasks.add('apostrophe-attachments', 'rescale',
      ...
      self.genex.tasks.add('apostrophe-attachments', 'migrate-to-disabled-file-key',
      ...
      self.genex.tasks.add('apostrophe-attachments', 'migrate-from-disabled-file-key',
      ...
      self.genex.tasks.add('apostrophe-attachments', 'urls',
