  ...
  init: function(editor) {
    ...
    editor.addCommand('split', new CKEDITOR.command(editor, {
      exec: function(editor) {
        var $area = editor.aposWidgetEditor.$widget.closest('[data-genex-area]');
        ...
        var splitMarker = genex.utils.generateId();
        ...
        function insertTwo(callback) {
          ...
          return setImmediate(function() {
            return areaEditor.addItem($widget, 'genesys-rich-text', {content: html2}, callback);
          });
        }
        ...
        function insertOne(callback) {
          ...
          // between rich text editors by waiting a tick
          return setImmediate(function() {
            return areaEditor.addItem($widget, 'genesys-rich-text', {content: html1}, callback);
          });
        }
      }
    }));
