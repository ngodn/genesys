// The `genesys-jobs` module runs long-running jobs in response
// to user actions. Batch operations on pieces are a good example.
//
// The `genesys-jobs` module makes it simple to implement
...
// see the examples already in `genesys-pieces` and those added
// by the `genesys-workflow` module. You don't need to go
...
//
// The `genesys-jobs` module DOES NOT have anything to do with
