...
//
// See [adding editable content to pages](https://docs.apostrophecms.org/apostrophe/tutorials/getting-started/adding-editable-content-to-pages#genesys-images) for a thorough discussion of the options that can be passed to the widget.
