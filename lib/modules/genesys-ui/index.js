// Provides the [genex.ui](browser-genesys-ui) singleton on the browser side, which
// implements various general purpose UI features for Apostrophe sites, and also
// the [genesys-context](browser-genesys-context) base class on the browser side,
...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.genex.push.browserCall('always', 'genex.create("genesys-ui", ?)',
      _.pick(self.options, 'userTimeFormat')
    );
    self.genex.templates.prepend('contextMenu', function (req) {
