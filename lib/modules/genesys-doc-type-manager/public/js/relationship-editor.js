genex.define('apostrophe-doc-type-manager-relationship-editor', {
  ...
  construct: function(self, options) {
    ...
    self.beforeShow = function(callback) {
      ...
      return genex.schemas.populate(self.$form, self.nonInlineSchema, self.choice, callback);
    };
    self.saveContent = function(callback) {
      return genex.schemas.convert(self.$form, self.nonInlineSchema, self.choice, {}, function(err) {
        if (err) {
          return callback(err);
        }
