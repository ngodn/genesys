genex.define('apostrophe-doc-type-manager', {
  extend: 'apostrophe-context',

  afterConstruct: function(self) {
    genex.docs.setManager(self.name, self);
  },
  ...
  construct: function(self, options) {
    ...
    self.getTool = function(name, options, callback) {
      ...
      if (!callback) {
        return genex.create(self.getToolType(name), _options);
      }
      return genex.create(self.getToolType(name), _options, callback);
    };
