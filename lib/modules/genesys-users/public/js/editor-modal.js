...
genex.define('genesys-users-editor-modal', {

  extend: 'genesys-pieces-editor-modal',
  ...
  construct: function(self, options) {
    ...
    self.enableTitleViaName = function() {
      self.$title = genex.schemas.findField(self.$el, 'title');
      self.$firstName = genex.schemas.findField(self.$el, 'firstName');
      self.$lastName = genex.schemas.findField(self.$el, 'lastName');
    ...
    self.enableUsernameViaTitle = function() {
      self.$username = genex.schemas.findField(self.$el, 'username');
    ...
    self.updateUsernameViaTitle = function() {
      ...
      var username = genex.utils.slugify(self.$title.val());
