...
//
// The [genesys-pieces-pages](https://docs.apostrophecms.org/apostrophe/modules/genesys-pieces-pages) module
  ...
  beforeConstruct: function(self, options) {
    ...
    options.addFields = [
      ...
      },
      {
        ...
        label: 'Type',
        required: true,
        choices: _.map(options.genex.pages.typeChoices, function(type) {
          return {
            value: type.name,
            label: type.label
          };
