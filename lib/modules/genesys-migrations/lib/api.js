...
module.exports = function(self, options) {
  ...
  // Add a migration function to be invoked when the genesys-migrations:migrate task is invoked.
  //
  ...
  self.eachDoc = function(criteria, limit, iterator, callback) {
    ...
    return self.each(self.genex.docs.db, criteria, limit, iterator, callback);
  };
  ...
  // to run the `genesys-migration:migrate` task.
  //
  ...
  self.addSortify = function(migrationNamePrefix, criteria, field) {
    self.add(migrationNamePrefix + ':' + field + '-sortified', function(callback) {
      ...
      return self.eachDoc({
        ...
        var $set = {};
        $set[field + 'Sortified'] = self.genex.utils.sortify(doc[field]);
