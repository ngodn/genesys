genex.define('apostrophe-images-relationship-editor', {
  ...
  construct: function(self, options) {
    ...
    self.action = genex.docs.getManager(options.field.withType).options.action;
    ...
    self.crop = function() {
      ...
      return genex.attachments.crop(self.image.attachment, options, function(err, crop) {
        if (err) {
