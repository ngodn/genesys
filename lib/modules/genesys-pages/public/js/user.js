  ...
  construct: function(self) {
    self.addLinks = function() {
      genex.ui.link('genex-insert', 'page', function() {
        genex.create('genesys-pages-editor', { action: self.options.action });
      });
      genex.ui.link('genex-copy', 'page', function() {
        genex.create('genesys-pages-editor-copy', { action: self.options.action });
      });
      genex.ui.link('genex-update', 'page', function() {
        genex.create('genesys-pages-editor-update', { action: self.options.action });
      });
    ...
    self.reorganize = function() {
      genex.create('genesys-pages-reorganize',
    ...
    self.chooserModal = function(options) {
      return genex.create('genesys-pages-reorganize',
        _.assign(
          {
