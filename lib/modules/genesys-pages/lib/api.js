...
module.exports = function(self, options) {
  ...
  self.lock = function(req, callback) {
    ...
    return self.genex.locks.lock('apostrophe-pages:tree', function(err) {
      if (!err) {
  ...
  self.unlock = function(req, callback) {
    ...
    return self.genex.locks.unlock('apostrophe-pages:tree', callback);
  };
  ...
  self.manageOrphans = function(callback) {
    ...
    function manage(callback) {
      ...
      self.genex.utils.error('* Listing them as "types" for "apostrophe-pages", OR');
      self.genex.utils.error('* Providing an appropriate subclass of apostrophe-pieces.');
      self.genex.utils.error();
  ...
  self.genex.tasks.add('apostrophe-pages', 'unpark',
  ...
  self.addToAdminBar = function() {
    self.genex.adminBar.add(self.__meta.name, 'Pages', 'edit-apostrophe-page');
  };
  ...
  // be passed to `genex.modules['apostrophe-jobs'].start()` on the rowser side to
  // monitor progress.
  //
  ...
  self.batchSimpleRoute = function(req, name, change) {
    ...
    function runJob() {
      return self.genex.modules['apostrophe-jobs'].run(req, one, {
        labels: {
