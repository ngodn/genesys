...
module.exports = function(self, options) {
  ...
  // of genesys-pieces often extend this to remove more default filters
  ...
  self.requirePiece = function(req, res, next) {
    var id = self.genex.launder.id(req.body._id);
  ...
  self.requirePieceEditorView = function(req, res, next) {
    ...
    if (!self.genex.permissions.can(req, 'edit-' + self.name)) {
  ...
  self.list = function(req, options, callback) {
    ...
    if (options.filters && options.filters.sortColumn) {
      ...
      var direction = self.genex.launder.select(options.filters.sortColumn.direction, [ '1', '-1', '1' ]);
    ...
    return async.series({
      ...
      populateFilters: function(callback) {
        ...
        // for the `piecesFilters` option of `genesys-pieces-pages`
  ...
  self.insert = function(req, piece, options, callback) {
    ...
    function body(callback) {
      ...
      if ((options.permissions !== false) &&
        (!self.genex.permissions.can(req, 'admin-' + self.name))) {
      ...
      function insert(callback) {
        self.genex.docs.insert(req, piece, options, callback);
      }
  ...
  self.update = function(req, piece, options, callback) {
    ...
    function body(callback) {
      ...
      function update(callback) {
        self.genex.docs.update(req, piece, options, callback);
      }
  ...
  self.trash = function(req, id, callback) {
    ...
    function body(callback) {
      if (self.genex.permissions.can(req, 'admin-' + self.name)) {
        // This user has blanket permission for this piece type
        permission = false;
      }
      return self.genex.docs.trash(req, id, {
  ...
  self.rescue = function(req, id, callback) {
    ...
    function body(callback) {
      ...
      return self.genex.docs.rescue(req, id, {
        permission: permission
      }, function(err, piece) {
        if (err) {
          return callback(err);
  ...
  self.convert = function(req, piece, callback) {
    return self.genex.schemas.convert(req, self.allowedSchema(req), 'form', req.body, piece, callback);
  };

  // Invoked after genex.schemas.convert by the `insert` and
  // `update` routes
  ...
  self.addToAdminBar = function() {
    self.genex.adminBar.add(self.__meta.name, self.pluralLabel, self.getEditPermissionName());
  };

  // Add `._url` properties to the given pieces, if possible.
  // The default implementation does nothing, however
  // [genesys-pieces-pages](https://docs.apostrophecms.org/apostrophe/modules/genesys-pieces-pages) will
  // call `setAddUrls` to point to [its own `addUrlsToPieces` method](https://docs.apostrophecms.org/apostrophe/modules/genesys-pieces-pages#addurlstopieces-req-results-callback).
  ...
  // Called by [genesys-pieces-pages](https://docs.apostrophecms.org/apostrophe/modules/genesys-pieces-pages) to
  ...
  // See [the `addUrlsToPieces` method of `genesys-pieces-pages`](https://docs.apostrophecms.org/apostrophe/modules/genesys-pieces-pages#addurlstopieces-req-results-callback).
  ...
  // by the optional `genesys-pieces-rest-api` module.
  //
