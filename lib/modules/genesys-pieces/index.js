// `genesys-pieces` provides a "base class" you can extend to create new content
...
// `genesys-pieces-pages` module to display an index page and permalink pages
// for your pieces, and use `genesys-pieces-widgets` to allow them to be sprinkled
...
module.exports = {
  ...
  construct: function(self, options) {
    if (!options.name) {
      throw new Error('genesys-pieces require name option');
    }
    if (!options.label) {
      // Englishify it
