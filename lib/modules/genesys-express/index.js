...
module.exports = {
  ...
  afterConstruct: function(self) {
    ...
    if (self.options.baseUrl && (!self.genex.baseUrl)) {
      self.genex.utils.error('WARNING: you have baseUrl set as an option to the `apostrophe-express` module.');
  ...
  construct: function(self, options) {
    ...
    self.sessions = function() {
      ...
      if (sessionOptions.secret === 'you should have a secret') {
        self.genex.utils.error('WARNING: No session secret provided, please set the `secret` property of the `session` property of the apostrophe-express module in app.js');
      }
