...
// `find()` method of the `apostrophe-docs` module (`genex.docs.find`).
...
//
// ```
// return genex.docs.getManager('apostrophe-blog').
//   find().
//   limit(10).
  ...
  construct: function(self, options) {
    ...
    self.finalizeSort = function() {
      ...
      if (sort) {
        ...
        var manager = self.genex.docs.getManager(self.get('type') || 'apostrophe-page');
        if (!(manager && manager.schema)) {
          return;
        }
