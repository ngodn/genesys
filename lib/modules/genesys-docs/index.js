...
// is `genex.docs.find()`, which returns a [cursor](https://docs.apostrophecms.org/apostrophe/modules/genesys-docs/server-genesys-cursor) for
// fetching documents of all types. This is useful when implementing something
// like the [genesys-search](https://docs.apostrophecms.org/apostrophe/modules/genesys-search) module.
//
// ## Options
//
...
// moving pages from trashing pages, which is useful for the `genesys-workflow`
...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.genex.define('genesys-cursor', require('./lib/cursor.js'));
