...
// is `genex.docs.find()`, which returns a [cursor](https://docs.apostrophecms.org/apostrophe/modules/apostrophe-docs/server-apostrophe-cursor) for
...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.genex.define('apostrophe-cursor', require('./lib/cursor.js'));
