genex.define('apostrophe-rich-text-widgets-editor', {
  ...
  construct: function(self, options) {
    ...
    self.start = function() {
      ...
      if (!self.id) {
        ...
        self.id = genex.utils.generateId();
    ...
    // `genex-active` CSS class. Reflects what has already happened
    ...
    self.setActive = function(state) {
      ...
      return self.$widget.toggleClass('genex-active', state);
    };
