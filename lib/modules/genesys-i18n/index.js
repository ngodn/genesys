...
// as `genex.i18n`. Apostrophe also makes this available in Nunjucks templates via the
...
module.exports = {
  construct: function(self, options) {
    ...
    _.defaults(i18nOptions, {
      locales: [ 'en' ],
      cookie: self.genex.shortName + '.locale',
      directory: self.options.localesDir || (self.genex.rootDir + '/locales')
    });
    i18n.configure(i18nOptions);

    // Make the i18n instance available globally in Apostrophe
    self.genex.i18n = i18n;
  }
};
